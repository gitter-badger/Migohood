...
@section('content')
  ...
  <div class="title">
     <h5>Pricing</h5>
     <p  class="light">Choose your own price, Migohood got only .5% </p>
  ...
  <div class="input-field col s3">
    <select name="coin" required >
      <option value="" disabled selected>Choose one</option>
      <option value="USD" @if($space->coin == 'USD') selected="selected" @endif>USD </option>
      <option value="COP" @if($space->coin == 'COP') selected="selected" @endif>COP</option>
    </select>
