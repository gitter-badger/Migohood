...
@section('menu')
  <ul>
    ...
    <a href="{{ route('space.router', ['hash' => $space->hash, 'route' => 'description' ]) }}"><li class="active"><i class="material-icons left">border_color</i>Description</li></a>
...
@section('content')
  ...
  <!-- Uddate Space Description -->
  <form class="form row" form action="{{ route('space.router.update', ['hash' => $space->hash, 'route' => 'description' ]) }}" method="POST">
    {{ csrf_field() }}
