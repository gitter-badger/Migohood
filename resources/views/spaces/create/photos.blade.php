...
@section('content')
  ...
  <form class="form row" id="pic" action="{{ route('space.thumbnail.update', ['hash' => $space->hash ]) }}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
  ...
  <div class="title">
    ...
    <form class="" id="pic" action="{{ route('space.gallery.update', ['hash' => $space->hash ]) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
  ...
  <div class="form row">
    ...
    <div class="col s12 submit">
      ...
      <div class="right">
        <a href="{{ route('space.pricing', ['hash' => $space->hash ]) }}" class="btn btn-save" id="next">Save and Continue</a>
      </div>
    </div>
    <!-- Submit -->
  </div>
