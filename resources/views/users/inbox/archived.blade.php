...
<div class="col s2">
  <div class="menu container">
    <ul>
      ...
      <a href="{{ url('/inbox/sent') }}"><li><i class="material-icons left">send</i>Sent </li></a>
      <a href="{{ url('/inbox/archived') }}"><li class="active"><i class="material-icons left">drafts</i>Archived</li></a>
    </ul>
 </div>
</div>
<!-- Menu Left -->
...
<div class="container col s10">
  ...
  <div class="box">
    <div class="box-nothing">
      ...
      <p class="light">You don't have any message archived</p>
    </div>
  </div>
  <!-- Box Nothing -->
