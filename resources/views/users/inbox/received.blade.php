...
<div class="col s2">
  <div class="menu container">
    <ul>
      <a href="{{ url('/inbox') }}"><li class="active"><i class="material-icons left">mail</i>Received</li></a>
...
<div class="container col s10">
  ...
  <div class="box">
    <div class="box-nothing">
      ...
      <p class="light">You don't have any message received</p>
    </div>
  </div>
  <!-- Box Nothing -->
