...
<div class="col s2">
  <div class="menu container">
    <ul>
      <a href="{{ url('/dashboard') }}"><li class="active"><i class="material-icons left">developer_board</i>Dashboard</li></a>
...
<div class="container col s10">
  ...
  <div class="box">
    <div class="box-nothing">
      ...
      <p class="light">You don't have any activity in your dashboard</p>
    </div>
  </div>
  <!-- Box Nothing -->
