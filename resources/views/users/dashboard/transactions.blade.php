@extends('layouts.app')
@section('title', 'Dashboard - Transactions history')
@section('content')
<!-- Options NavBar -->
<div id="options">
...
<div class="col s2">
  <div class="menu container">
    <ul>
      ...
      <a href="{{ url('/dashboard/transactions') }}"><li class="active"><i class="material-icons left">history</i>Transactions </li></a>
    </ul>
 </div>
</div>
<!-- Menu Left -->
...
<div class="container col s10">
  ...
  <div class="box">
    <div class="box-nothing">
      ...
      <p class="light">There is no transactions history</p>
    </div>
  </div>
  <!-- Box Nothing -->
