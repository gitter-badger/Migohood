@extends('layouts.app')
@section('title', 'Dashboard - Pending Payment')
@section('content')
<!-- Options NavBar -->
<div id="options">
...
<div class="col s2">
  <div class="menu container">
    <ul>
      ...
      <a href="{{ url('/dashboard/pending_payment') }}"><li class="active"><i class="material-icons left">event</i>Pending Payment </li></a>
...
<div class="container col s10">
  ...
  <div class="box">
    <div class="box-nothing">
      ...
      <p class="light">You don't have any pending payment</p>
    </div>
  </div>
  <!-- Box Nothing -->
